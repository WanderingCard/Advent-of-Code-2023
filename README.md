...
```
Stars Earned: 20
Part Ones Finished: 10 (Last: Day 10)
Part Twos Finished: 10 (Last: Day 10)
Days Completed: 10 (Last: Day 10)
```
## Day One
> Language: Python
...
**Part One**
> The input represents a maze of pipes heading in various directions, and ground characters. Going from the starting pipe, find the enclosed loop generated by the pipes, and count the furthest space from the start location

**Part Two**
> Count the number of spaces enclosed by the pipe loop.
